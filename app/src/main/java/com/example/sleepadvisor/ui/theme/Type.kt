...
// Tipografia personalizada para o SleepAdvisor
...
val Typography.cardSubtitle: TextStyle
    get() = this.bodyMedium.copy(color = Color.Gray)
...
val Typography.statValue: TextStyle
    get() = this.headlineMedium.copy(fontWeight = FontWeight.Bold)

val Typography.statLabel: TextStyle
    get() = this.labelMedium.copy(color = Color.Gray)